...
(cl:defclass <salidaKalman> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass salidaKalman (<salidaKalman>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <salidaKalman>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'salidaKalman)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name seguimiento-msg:<salidaKalman> is deprecated: use seguimiento-msg:salidaKalman instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <salidaKalman>))
...
(cl:defmethod identificador-val ((m <salidaKalman>))
...
(cl:defmethod pan-val ((m <salidaKalman>))
...
(cl:defmethod tilt-val ((m <salidaKalman>))
  ...
  (tilt m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <salidaKalman>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <salidaKalman>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<salidaKalman>)))
  "Returns string type for a message object of type '<salidaKalman>"
  "seguimiento/salidaKalman")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'salidaKalman)))
  "Returns string type for a message object of type 'salidaKalman"
  "seguimiento/salidaKalman")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<salidaKalman>)))
  "Returns md5sum for a message object of type '<salidaKalman>"
  "258285ea72a30809b9246ee654073a66")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'salidaKalman)))
  "Returns md5sum for a message object of type 'salidaKalman"
  "258285ea72a30809b9246ee654073a66")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<salidaKalman>)))
  "Returns full string definition for message of type '<salidaKalman>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'salidaKalman)))
  "Returns full string definition for message of type 'salidaKalman"
  (cl:format cl:nil "Header header~%int32[] identificador~%float32[] pan~%float32[] tilt~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <salidaKalman>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <salidaKalman>))
  "Converts a ROS message object to a list"
  (cl:list 'salidaKalman
