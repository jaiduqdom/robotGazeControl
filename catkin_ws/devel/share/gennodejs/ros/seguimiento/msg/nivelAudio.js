...
class nivelAudio {
  ...
  static datatype() {
    ...
    return 'seguimiento/nivelAudio';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'b7f88596f71fe2965f91f0e52ac92c01';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new nivelAudio(null);
