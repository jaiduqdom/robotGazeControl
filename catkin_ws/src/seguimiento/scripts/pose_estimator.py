...
class PoseEstimator:
    ...
    def _get_full_model_points(self, filename='/home/disa/catkin_ws/src/seguimiento/scripts/assets/model.txt'):
    ...
    def dibuja_linea_infinito(self, image, rotation_vector, translation_vector, color=(255, 0, 0), line_width=3):
        """Dibuja una linea hasta el infinito para detectar si la persona esta mirando al robot"""
        point_3d = []
        point_3d.append((0, 0, 0))
        point_3d.append((0, 0, 500))
  
        point_3d = np.array(point_3d, dtype=np.float).reshape(-1, 3)

        #print("ROTATION VECTOR")
        #print(rotation_vector)
        #print("TRASLATION VECTOR")
    ...
    def calcular_angulo_mirada(self, point1, point2):
	x1 = point1[0]
	y1 = point1[1]
	x2 = point2[0]
	y2 = point2[1]
        # Están invertidos ya que en vertical cuanto más arriba es más pequeño (0-480)
        angulo = math.atan2(y1 - y2, x2 - x1)
	return angulo

    def calcula_direccion(self, image, rotation_vector, translation_vector, color=(255, 0, 0), line_width=3):
        """Dibuja una linea hasta el infinito para detectar si la persona esta mirando al robot"""
        p1 = []
        p1.append((0, 0, 0))
        p1.append((0, 0, 500))
        p2 = []
        p2.append(rotation_vector * p1[0] + translation_vector)
        p2.append(rotation_vector * p1[1] + translation_vector)
        #print(p2[0])
        #print(p2[1])
